...
public class GenerateMarc21RDA_DataDriven_Tests {
	public static final String kTestDataDirPath = "src//test//resources//Marc21RDA_Regression_Test_Data//";
	...
	public static class PubAndMarcRecord {
		...
		public static PubAndMarcRecord makeFor(IMarcProvider marcProvider, String pubId) throws Exception {
			MarcRecord marcRecord = marcProvider.getMarc21RDAResultFor(pubId);
