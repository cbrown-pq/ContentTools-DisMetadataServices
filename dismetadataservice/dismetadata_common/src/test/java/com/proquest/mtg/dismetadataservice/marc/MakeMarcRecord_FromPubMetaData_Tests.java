...
public class MakeMarcRecord_FromPubMetaData_Tests {
	...
	public void verifyMarcRecordHasSingleField(DisPubMetaData metaData, String tag, String expectedMarcFieldData, int dataSpecificFieldCount) {
...
//	}
	...
	public void withOnly_LocationOfCopy() throws Exception {
		...
		String expectedMarcFieldData = "2 " + MarcCharSet.kSubFieldIndicator + "a" + locationOfCopy + ".";
	...
	public void withOnly_Subjects() throws Exception {
		...
		String expectedSubjectTermFieldData1 = " 4" + MarcCharSet.kSubFieldIndicator + "a" +  "Business Administration, Management.";
		String expectedSubjectTermFieldData2 = " 4" + MarcCharSet.kSubFieldIndicator + "a" +  "Engineering, Industrial.";
		String expectedSubjectTermFieldData3 = " 4" + MarcCharSet.kSubFieldIndicator + "a" +  "Operations Research.";
		
		String expectedSubjectCodeFieldData1 = "  " + MarcCharSet.kSubFieldIndicator + "a" +  "0454";
		String expectedSubjectCodeFieldData2 = "  " + MarcCharSet.kSubFieldIndicator + "a" +  "0546";
		String expectedSubjectCodeFieldData3 = "  " + MarcCharSet.kSubFieldIndicator + "a" +  "0796";
		
		MarcRecord marc = factory.makeFrom(metaData);
		assertThat(marc.getFieldCount(), is(6 + kDataIndependentFieldCount));
		
		List<MarcField> subjectTermFields = marc.getFieldsMatchingTag(MarcTags.kSubjectTerm); 
		assertThat(subjectTermFields.size(), is(3));
		assertThat(subjectTermFields.get(0).getData(), is(expectedSubjectTermFieldData1));
		assertThat(subjectTermFields.get(1).getData(), is(expectedSubjectTermFieldData2));
		assertThat(subjectTermFields.get(2).getData(), is(expectedSubjectTermFieldData3));
		
		List<MarcField> subjectCodeFields = marc.getFieldsMatchingTag(MarcTags.kSubjectCode); 
		assertThat(subjectCodeFields.size(), is(3));
		assertThat(subjectCodeFields.get(0).getData(), is(expectedSubjectCodeFieldData1));
		assertThat(subjectCodeFields.get(1).getData(), is(expectedSubjectCodeFieldData2));
		assertThat(subjectCodeFields.get(2).getData(), is(expectedSubjectCodeFieldData3));
	}
...
//		assertThat(marc.getFieldsMatchingTag(MarcTags.kLocationOfCopy).size(), is(1));
//		assertThat(marc.getFieldsMatchingTag(MarcTags.kSubjectTerm).size(), is(3));
//		assertThat(marc.getFieldsMatchingTag(MarcTags.kSubjectCode).size(), is(3));
//	}
