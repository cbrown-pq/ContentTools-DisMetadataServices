...
public class PubMetaDataProvider_Tests {
	...
	public void pubWith_NoVolumeIssue_ReturnsNull() throws Exception {
		...
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.noVolumeIssuePub1,0);
	...
	public void pubWith_MissingPubID_ReturnsNull() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.fakePub1,0);
		assertThat(metaDataResult, nullValue());
	}
	...
	public void multipleSubjects_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId0,0);
	...
	public void nullLocationCopy_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId1,0);
	...
	public void nullAbstract_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId2,0);
	...
	public void britishPub_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId3,0);
	...
	public void chinesePub_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId4,0);
	...
	public void electronicTitle_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId5,0);
	...
	public void supplementalFile_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId6,0);
	...
	public void normalPub_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId7,0);
	...
	public void multipleAuthors_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId8,0);
	...
	public void candianPub_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId9,0);
	...
	public void pubMultipleLanguages_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId10,0);
	...
	public void pubMultipleDepartment_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId11,0);
	...
	public void pubWithFoerignTitle_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId12,0);
	...
	public void pubWithMultipleFormatRestriction_test() throws Exception {
		DisPubMetaData metaDataResult;
		metaDataResult = target.getPubMetaDataFor(MakeExodusMetadataForTesting.pubId13,0);
