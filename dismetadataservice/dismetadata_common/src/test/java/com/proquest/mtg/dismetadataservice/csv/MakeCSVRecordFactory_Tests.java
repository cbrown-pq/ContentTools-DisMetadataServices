...
public class MakeCSVRecordFactory_Tests {
	...
	public void acceptance1() throws Exception {
		...
		String expectedCSVData = header
				+ "\r\n\"3569004\",,\"Moriarty, Matthew D.|Kinstlinger, Gary\",\"978-1-303-03106-9\",,,\"Kuopion Yliopiston Painatuskeskus, Kuopio, Finland\",\"DEPT. OF PHARMACOLOGY, KAROLINSKA INSTITUTE, BOX 60400, S-104 01         STOCKHOLM, SWEDEN\",,\"http://pq.com/pub:3569004\",\"http://www.theses.com/idx/registered_users/etd/8f.asp\",,,\"0753\",\"Massachusetts Institute of Technology\",\"UNITED STATES\",\"Massachusetts\",,,,,,,,,\"Language, Literature and Linguistics\",\"0297\",\"Literature, Medieval\",\"N\",,,,,,,,,,,,,,\"N\",,,,,,,,,,,";
	...
	public void acceptance2() throws Exception {
		...
		String expectedCSVData = header
				+ "\r\n\"3569004\",,\"Moriarty, Matthew D.|Kinstlinger, Gary\",,,,,\"DEPT. OF PHARMACOLOGY, KAROLINSKA INSTITUTE, BOX 60400, S-104 01         STOCKHOLM, SWEDEN\",,,,,,\"0753\",\"Massachusetts Institute of Technology\",\"UNITED STATES\",\"Massachusetts\",\"NAD(+)-glycohydrolase in runderschildklier:  Afzonderen, eigenschappen en bereiden van monoklonale antistoffen.  (Dutch text).\",\"Utilization of an articulation index procedure in the evaluation of hearing-aid efficiency.\",\"Adsorption kinetics at the air-water interface.  \\lbrack Dutch text\\rbrack\",,,,,,\"Language, Literature and Linguistics\",\"0297\",\"Literature, Medieval\",\"N\",,,,,,,,,,,,,,\"N\",,,,,,,,,,,";
		String csvData = factory.makeFrom(metadata);
		assertThat(csvData, is(expectedCSVData));
	}
	...
	public void acceptance4() throws Exception {
		...
		String expectedCSVData = header
				+ "\r\n\"3569004\",,,,,,,,,,,,,,,,,,,,,,,,,,,,\"N\",,,,,,,,,,,,,,\"N\",,\"C|CE\",\"NONE|NONE\",\"NONE|NONE\",,,,,,,";
		String csvData = factory.makeFrom(metadata);
		assertThat(csvData, is(expectedCSVData));
	}
