...
public class Marc21RdaRecordFactory_MakeAbstract_Tests extends Marc21RdaRecordFactory_Test_Helper {
	...
	public void withOnly_Abstract_WithLessThanAndGreaterThanSgmlEntityTags() throws Exception {
		...
		List<MarcField> abstractFields = marc.getFieldsMatchingTag(MarcTags.kAbstract); 
		assertThat(abstractFields.size(), is(3));
		assertThat(abstractFields.get(0).getData(), is(expectedMarcFieldData1));
		assertThat(abstractFields.get(1).getData(), is(expectedMarcFieldData2));
		assertThat(abstractFields.get(2).getData(), is(expectedMarcFieldData3));
	}
